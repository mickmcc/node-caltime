 ...
 * @param {Number} [inDurationMins] Integer representing the duration of the
 ...
 * @param {Number} [inDurationSecs] Integer representing the [seconds] component
 * of the duration. Value defaults to zero if not specified.
 * An error is thrown if both inEnd and inDurationMins are specified.
 * @param {Number} [inDurationMSecs] Integer representing the [milliseconds]
 ...
 * @throws {Error}
 */
let dateSpan = function timeSpanFunc(inBegin,
                                      inEnd=null,
                                      inDurationMins=0,
                                      inDurationSecs=0,
                                      inDurationMSecs=0) {
