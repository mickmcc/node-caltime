...
describe('Timespan - Instantiation', function() {
  ...
  it('Attempt to create timespans which are too long', function() {
    ...
    assert.throws(function() { tc.spanCtor(23, 0, 0, 0, 2*60) },
                    Error,
                    'Expected functional constructor to throw an error.');
    assert.throws(function() { tc.spanCtor(23, 0, 0, 0, 61) },
                    Error,
                    'Expected functional constructor to throw an error.');
    assert.throws(function() { tc.spanCtor(1, 0, 0, 0, tc.constants.MAX_MINS_PER_DAY) },
                    Error,
                    'Expected functional constructor to throw an error.');
